$(function() {
  ...
  var options_tech = {
    url: function(entreprise) {
      return "php/recherche_collab_users.php?type=tech&entreprise="+entreprise;
    },
    getValue: function(element) {
    //  console.log(element);
      return element.visuel;
  ...
  var max_fields = 10;
  var wrapper = $(".input_fields_wrap_modification");
  var add_button = $(".add_field_button_modification_modification");
  var x = 1;
